...
function setupCors(app: express.Application) {
  app.use((req, res, next) => {
    ...
    if (process.env.CUSTOM_DOMAIN) {
      allowedOrigins.add(`https://${process.env.CUSTOM_DOMAIN}`);
    }
...
function serveLandingPage({
  ...
  try {
    ...
    // Prefer CUSTOM_DOMAIN env var so Expo deep links always use the correct domain
    const expsUrl = process.env.CUSTOM_DOMAIN || `${host}`;
