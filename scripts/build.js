...
function getDeploymentDomain() {
  ...
  console.warn(
    "WARNING: No deployment domain found. Using fallback domain.",
  );
  return "dhanraj-bike-recovery--jairajthakur112.replit.app";
}
...
async function startMetro(expoPublicDomain) {
  ...
  console.error("Metro timeout - static Expo web bundle skipped, server will still deploy");
...
main().catch((error) => {
  console.warn("Static Expo build skipped:", error.message);
  console.warn("Server will deploy without static web bundle. API and landing page will still work.");
  if (metroProcess) {
    metroProcess.kill();
  }
  process.exit(0);
